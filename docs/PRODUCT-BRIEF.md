...
---
*Companion docs: `PRD.md` (epics + features), `PERSONAS.md` (personas), `DB-SCHEMA.md` (database schema), `CAPSTONE-SPEC.md` (submission one-pager, TBD), `CAPSTONE-PLAN.md` (architecture + diagrams, TBD), `../web/src/app/dashboard/` (interactive mock as React pages, served at `/dashboard`).*
